...
public class DbAdapter {
    ...
    public static final String KEY_BODY = "LegacyAPN";
    ...
    private static final String DATABASE_CREATE =
        ...
        + "WebTitle text not null, LegacyAPN text not null, STATUS text);";
    ...
    public Cursor fetchAllNotes() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_TITLE,
                KEY_BODY, KEY_STATUS}, null, null, null, null, null);
    }
     ...
     */
    public boolean updateNote(long rowId, String title, String body, String status) {
